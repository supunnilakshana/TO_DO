...
public class MainActivity extends AppCompatActivity {
   ...
   private TextView count;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ToDoAdapter adapter = new ToDoAdapter(context,R.layout.single_to_do,toDos);

        listView.setAdapter(adapter);

        //get todo counts from the table
        //int countTodo = dbHandler.countToDo();
        int ucountTODO= dbHandler.unfinishTODO();
        if(ucountTODO==0){
            count.setText("You have not unfinish todos");
        }else if (ucountTODO==1){
            count.setText("You have a unfinish todo");
        }else{
            count.setText("You have "+ucountTODO+" unfinish todos");
        ...
        add.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(context,add_to_do.class));
            }
        });
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                builder.setNeutralButton("Update", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        Intent intent = new Intent(context,edit_to_do.class);
