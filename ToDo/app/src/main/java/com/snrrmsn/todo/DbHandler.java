...
public class DbHandler extends SQLiteOpenHelper {
    ...
    public ToDo getSingleToDo(int id){
        ...
        Cursor cursor = db.query(TABLE_NAME,new String[]{ID,TITLE,DESCRIPTION,DATE,STARTED, FINISHED},
    ...
    public int unfinishTODO(){
        SQLiteDatabase db = getReadableDatabase();
        String query = "SELECT * FROM  "+ TABLE_NAME+" WHERE FINISHED=0";
